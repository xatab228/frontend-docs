...
Помимо BST из раздела выше, на практике часто нужен обход дерева — например, для рендера вложенного меню или дерева комментариев.
